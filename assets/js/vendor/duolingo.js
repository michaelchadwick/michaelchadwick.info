...
class Duolingo {
     ...
     */
    constructor(opts) {
        this.duoHost = 'https://www.duolingo.com';
     ...
     */
    async getData () {
        const URL = `${this.duoHost}/users/${this.userName}`;
        try{
     ...
     */
    async getVocabulary() {
        const URL = `${this.duoHost}/vocabulary/overview`;
        try{
            let result = await this.apiRequest('GET', URL)
            return result.data;
        }catch(e){
    ...
    async switchLanguage(lang){
        const URL = `${this.duoHost}/switch_language`
